...
public class AuthToken
{
    @InjectLinks({
            ...
            @InjectLink(resource = LoginResource.class, style = InjectLink.Style.ABSOLUTE, rel = "self login", title = "Login", type= OkupaInfoMediaType.OKUPAINFO_AUTH_TOKEN),
            @InjectLink(resource = LoginResource.class, style = InjectLink.Style.ABSOLUTE, rel = "logout", title = "Logout"),
            @InjectLink(resource = UserResource.class, method = "getUser", style = InjectLink.Style.ABSOLUTE, rel = "user-profile", title = "User profile", type= OkupaInfoMediaType.OKUPAINFO_USER, bindings = @Binding(name = "id", value = "${instance.userid}"))
    })
