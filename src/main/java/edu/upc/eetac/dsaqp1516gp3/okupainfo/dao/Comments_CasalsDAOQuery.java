...
public interface Comments_CasalsDAOQuery
{
    ...
    String GET_COMMENT_BY_CREATORID = "select hex(id) as id, hex(creatorid) as creatorid, hex(casalid) as casalid, content, creation_timestamp from comments_casals where creatorid=unhex(?)";
