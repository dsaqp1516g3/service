...
public interface CasalDAOQuery
{
    ...
    String GET_CASAL_BY_CASALID = "select hex(c.casalid) as casalid, hex(c.adminid) as adminid, c.email, c.name, c.description, c.localization, c.latitude, c.longitude, c.validado from casals c where casalid=unhex(?)";
    ...
    String GET_VALIDATED_CASALS = "select hex(casalid) as casalid, hex(adminid) as adminid, email, name, description, localization, validado from casals where validado=TRUE";
    String GET_NO_VALIDATED_CASALS = "select hex(casalid) as casalid, hex(adminid) as adminid, email, name, description, localization, validado from casals where validado=FALSE";
