...
public interface CasalDAOQuery
{
    ...
    String GET_VALIDATED_CASALS = "select hex(casalid) as casalid, hex(adminid) as adminid, email, name, description, localization, validado, image from casals where validado=TRUE";
