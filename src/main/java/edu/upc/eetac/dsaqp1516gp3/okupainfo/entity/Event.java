...
public class Event {
    ...
    @InjectLinks({
            ...
            @InjectLink(resource = CasalResource.class, method = "getEvent", style = InjectLink.Style.ABSOLUTE, rel = "self", title = "Event profile", type = OkupaInfoMediaType.OKUPAINFO_CASAL, bindings = {@Binding(name = "casalid", value = "${instance.casalid}"), @Binding(name = "id", value = "${instance.id}")})
    })
